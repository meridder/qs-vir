...
os.system('cp -r ../QSVir_Nov/QSVir_Nov.ms .')
os.system('cp -r ../QSVir_Nov/QSVir_Nov.ms.flagversions .')
...
# Flagging now moved to pipeline script and read in from a text file.
# Apply some manual flagging to correct for some missed flags
#flagdata(vis='{}.ms'.format(ms_prefix), mode='manual', spw='0,1', flagbackup=False)
#flagdata(vis='{}.ms'.format(ms_prefix), mode='manual', antenna ='ea07', spw='0~15', flagbackup=False)
#flagdata(vis='{}.ms'.format(ms_prefix), mode='manual', timerange='2022/11/28/15:10:50.5~2022/11/28/15:10:54.5', spw='16~31', flagbackup=False)
#flagdata(vis='{}.ms'.format(ms_prefix), mode='manual', antenna ='ea04', spw='16~47', flagbackup=False)
#flagdata(vis='{}.ms'.format(ms_prefix), mode='manual', timerange='2022/11/28/15:28:59.5~2022/11/28/15:29:03.5', spw='32~63', flagbackup=False)
#flagdata(vis='{}.ms'.format(ms_prefix), mode='manual', spw='32:2,21,22,23,46', flagbackup=False)
#flagdata(vis='{}.ms'.format(ms_prefix), mode='manual', antenna ='ea01', spw='48~79', flagbackup=False)
#flagdata(vis='{}.ms'.format(ms_prefix), mode='manual', timerange='2022/11/28/15:16:26.5000~2022/11/28/15:16:30.5000', spw='48~79', flagbackup=False)
#flagdata(vis='{}.ms'.format(ms_prefix), mode='manual', timerange='2022/11/28/15:16:29.5000~2022/11/28/15:16:33.5000', spw='48~79', flagbackup=False)
#flagdata(vis='{}.ms'.format(ms_prefix), mode='manual', spw='0~3', flagbackup=False)
#flagdata(vis='{}.ms'.format(ms_prefix), mode='manual', spw='0~15', antenna='ea19', flagbackup=False)
...
for table_name in table_name_array:
    os.system('cp -r ../QSVir_Nov/*{} .'.format(table_name))
...
print('Defining Lin. Pol. Polarization Model')
